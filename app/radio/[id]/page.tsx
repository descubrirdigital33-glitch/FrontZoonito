...
// esto de aca para arriba funciona
...
const Player: React.FC<PlayerProps> = ({
    ...
    const {
        ...
        isOwner,
        isPlaying,
        micVolume,      // 🎤 Pasa el estado del volumen del micrófono
        musicVolume,    // 🎵 Pasa el estado del volumen de la música
        isMicMuted      // 🔇 Pasa el estado de muteo del micrófono
    });
