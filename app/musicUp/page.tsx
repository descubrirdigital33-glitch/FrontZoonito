            ...
            await Promise.all(batch.map(async (track) => {
                ...
                try {
                    ...
                    if (track.audioFile) {
                        ...
                        console.warn(`⚠️ Track "${track.title}" no tiene archivo de audio`);
                        return;
                    }

                    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                    console.log("🔍 VERIFICANDO COVER:");
                    console.log("   - track.coverFile existe?:", !!track.coverFile);
                    console.log("   - track.coverFile tipo:", track.coverFile?.type);
                    console.log("   - track.coverFile tamaño:", track.coverFile?.size, "bytes");
                    
                    if (track.coverFile) {
                        console.log("📤 SUBIENDO COVER A CLOUDINARY...");
                        coverUrl = await uploadToCloudinary(track.coverFile, "image");
                        console.log(`✅ Cover de "${track.title}" subido a Cloudinary:`, coverUrl);
                        console.log("✅ coverUrl variable asignada:", coverUrl);
                    } else {
                        console.log("⚠️ NO HAY coverFile, saltando subida de cover");
                    }
                    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                    ...
                    console.log("📀 Álbum:", track.album || "N/A");
                    console.log("🎸 Género:", track.genre || "N/A");
                    console.log("👤 Solista:", track.soloist);
                    console.log("⭐ Avance:", track.avance);
                    console.log("🆔 UserId:", userId);
                    console.log("🎧 AudioURL:", audioUrl.substring(0, 60) + "...");
                    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                    console.log("🖼️ COVER INFO:");
                    console.log("   - track.coverFile existe?:", !!track.coverFile);
                    console.log("   - coverUrl subido a Cloudinary?:", !!coverUrl);
                    console.log("   - coverUrl valor:", coverUrl || "❌ NO HAY");
                    console.log("   - payload.coverUrl:", payload.coverUrl || "❌ NO SE INCLUYÓ");
                    console.log("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
